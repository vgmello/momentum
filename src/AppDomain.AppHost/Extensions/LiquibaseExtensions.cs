...
public static class LiquibaseExtensions
{
    ...
    /// <remarks>
    ///     This method configures a Liquibase container that will run migrations for the
    ///     app_domain database using changelog files from the mounted volume.
    ...
    ///     resources (e.g., the app_domain database resource) to ensure those
