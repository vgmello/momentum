...
/// </summary>
/// <remarks>
/// <para><strong>Purpose in Code Generation:</strong></para>
/// <para>This class acts as a data container that bridges the gap between Roslyn's type analysis and source code generation.
/// It aggregates all information needed to generate both parameter providers and command handlers.</para>
/// 
...
/// </list>
/// 
/// <para><strong>Integration with Generation Pipeline:</strong></para>
/// <list type="bullet">
...
/// </list>
/// 
/// <para><strong>Property Mapping Strategy:</strong></para>
...
/// </list>
/// 
/// <para><strong>Return Type Analysis:</strong></para>
    ...
    DbCommandAttribute dbCommandAttribute)
{
    ...
    /// </param>
    /// <remarks>
    /// <para><strong>Usage in Generated Code:</strong></para>
    ...
    /// </list>
    /// 
    /// <para><strong>Parameter Name Resolution Priority:</strong></para>
    /// <list type="number">
    ...
    ///     (e.g., "global::System.Int32", "global::MyApp.Models.User", "global::System.Collections.Generic.IEnumerable&lt;global::MyApp.Models.Order&gt;").
    /// </param>
    ...
    /// </param>
    /// <remarks>
    /// <para><strong>Dapper Method Selection Logic:</strong></para>
    ...
    /// </list>
    /// 
    /// <para><strong>Generic Type Handling:</strong></para>
    ...
    /// </list>
    /// 
    /// <para><strong>Global Namespace Qualification:</strong></para>
    /// <para>All type names include global:: prefixes to avoid naming conflicts in generated code,
    /// ensuring the generated handlers work correctly regardless of using statements in consumer code.</para>
    /// </remarks>
    /// <example>
    /// <para><strong>Result Type Analysis Examples:</strong></para>
    /// <code>
