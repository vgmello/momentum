...
/// <summary>
///     Concrete implementation of <see cref="DbCommandTypeInfo"/> that performs comprehensive analysis of types marked with <see cref="DbCommandAttribute"/> 
///     using Roslyn's INamedTypeSymbol. This class bridges Roslyn's type system with the source generation pipeline.
/// </summary>
/// <remarks>
/// <para><strong>Analysis Responsibilities:</strong></para>
...
///   <item><strong>Interface Analysis:</strong> Determines if the type implements ICommand&lt;T&gt; or IQuery&lt;T&gt; and extracts return types</item>
...
/// </list>
/// 
/// <para><strong>Roslyn Integration Pattern:</strong></para>
...
/// </list>
/// 
/// <para><strong>Property Analysis Strategy:</strong></para>
/// <list type="bullet">
...
/// </list>
/// 
/// <para><strong>Validation and Diagnostics:</strong></para>
...
internal class DbCommandTypeInfoSourceGen : DbCommandTypeInfo
{
    ...
    /// </value>
    /// <remarks>
    /// <para>The source generator uses this property to determine whether to proceed with code generation.
    /// Types with errors are skipped, but warnings and info diagnostics don't prevent generation.</para>
    /// 
    /// <para><strong>Error vs Warning Strategy:</strong></para>
    /// <list type="bullet">
