...
```json
// appsettings.Local.json (excluded from Docker)
{
  "ConnectionStrings": {
    "Messaging": "localhost:9092"
  }
...
prod.main.public.invoices.v2         # Production main schema events v2
...
// Results in topic: dev.main.public.invoice-events.v2
```
