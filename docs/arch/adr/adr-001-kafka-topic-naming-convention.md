...
-   **Description:** An alternative where `public` topics have no scope segment (e.g., `prod.AppDomain.invoices.v1`) and only internal topics have a scope (e.g., `prod.AppDomain.internal.reconciliation.v1`).
